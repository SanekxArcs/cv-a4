    ...
    <>
      ...
      >
        ...
        <nav className="flex h-6 gap-5 md:hidden">
          ...
          >
            <span className="h-0.5 w-5 rounded-full bg-emerald-800 dark:bg-emerald-100"></span>
            <span className="h-0.5 w-5 rounded-full bg-emerald-800 dark:bg-emerald-100"></span>
            <span className="h-0.5 w-5 rounded-full bg-emerald-800 dark:bg-emerald-100"></span>
          </button>
          ...
          <div
            ...
            className={`${
              isOpen
                ? "absolute top-full left-0 right-0  mt-2 animate-fadeInDown rounded-md bg-emerald-300/30 backdrop-blur-md dark:bg-emerald-800/30 "
                : "hidden"
            }`}
            style={{top: "100%"}}
          >
